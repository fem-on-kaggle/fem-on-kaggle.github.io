...
if [[ ! -f $BOOST_INSTALLED ]]; then
    ...
    BOOST_ARCHIVE_PATH=${BOOST_ARCHIVE_PATH:-"https://github.com/fem-on-kaggle/fem-on-kaggle/releases/download/boost-20240224-081004-5a43ca5/boost-install.tar.gz"}
