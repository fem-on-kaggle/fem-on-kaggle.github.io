...
if [[ ! -f $BOOST_INSTALLED ]]; then
    ...
    BOOST_ARCHIVE_PATH=${BOOST_ARCHIVE_PATH:-"https://github.com/fem-on-kaggle/fem-on-kaggle/releases/download/boost-20260409-053948-25928f5/boost-install.tar.gz"}
