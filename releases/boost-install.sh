...
if [[ ! -f $BOOST_INSTALLED ]]; then
    ...
    BOOST_ARCHIVE_PATH=${BOOST_ARCHIVE_PATH:-"https://github.com/fem-on-kaggle/fem-on-kaggle/releases/download/boost-20240105-103539-8e10f1d/boost-install.tar.gz"}
