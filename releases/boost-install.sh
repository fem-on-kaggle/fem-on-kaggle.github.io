...
if [[ ! -f $BOOST_INSTALLED ]]; then
    ...
    BOOST_ARCHIVE_PATH=${BOOST_ARCHIVE_PATH:-"https://github.com/fem-on-kaggle/fem-on-kaggle/releases/download/boost-20260107-083514-40dc11c/boost-install.tar.gz"}
