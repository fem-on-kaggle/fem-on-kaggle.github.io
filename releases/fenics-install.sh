...
wget -O/dev/null -q https://github.com/fem-on-kaggle/fem-on-kaggle/releases/download/mock-20240111-070849-9b9a7aa/mock-install.tar.gz
...
#          https://fem-on-kaggle.github.io/releases/fenics-install.sh          #
#                                      to                                      #
#       https://fem-on-kaggle.github.io/releases/fenics-install-real.sh        #
