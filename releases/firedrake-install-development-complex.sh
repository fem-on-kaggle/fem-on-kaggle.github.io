...
if [[ ! -f $FIREDRAKE_INSTALLED ]]; then
    ...
    # Install vtk
    VTK_INSTALL_SCRIPT_PATH=${VTK_INSTALL_SCRIPT_PATH:-"https://github.com/fem-on-kaggle/fem-on-kaggle.github.io/raw/0ae2abb6/releases/vtk-install.sh"}
    ...
    FIREDRAKE_ARCHIVE_PATH=${FIREDRAKE_ARCHIVE_PATH:-"https://github.com/fem-on-kaggle/fem-on-kaggle/releases/download/firedrake-20260214-175107-922c6cc-development-complex/firedrake-install.tar.gz"}
