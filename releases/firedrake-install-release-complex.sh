...
if [[ ! -f $FIREDRAKE_INSTALLED ]]; then
    ...
    FIREDRAKE_ARCHIVE_PATH=${FIREDRAKE_ARCHIVE_PATH:-"https://github.com/fem-on-kaggle/fem-on-kaggle/releases/download/firedrake-20260904-161605-45f2129-release-complex/firedrake-install.tar.gz"}
