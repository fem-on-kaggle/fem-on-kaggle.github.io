...
if [[ ! -f $GMSH_INSTALLED ]]; then
    ...
    H5PY_INSTALL_SCRIPT_PATH=${H5PY_INSTALL_SCRIPT_PATH:-"https://github.com/fem-on-kaggle/fem-on-kaggle.github.io/raw/2c1ecdf/releases/h5py-install.sh"}
    ...
    OCC_INSTALL_SCRIPT_PATH=${OCC_INSTALL_SCRIPT_PATH:-"https://github.com/fem-on-kaggle/fem-on-kaggle.github.io/raw/90d049e/releases/occ-install.sh"}
    ...
    GMSH_ARCHIVE_PATH=${GMSH_ARCHIVE_PATH:-"https://github.com/fem-on-kaggle/fem-on-kaggle/releases/download/gmsh-20230319-140650-7a895ff/gmsh-install.tar.gz"}
