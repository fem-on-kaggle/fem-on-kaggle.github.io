...
if [[ ! -f $ITK_INSTALLED ]]; then
    # Install vtk
    VTK_INSTALL_SCRIPT_PATH=${VTK_INSTALL_SCRIPT_PATH:-"https://github.com/fem-on-kaggle/fem-on-kaggle.github.io/raw/a751400/releases/vtk-install.sh"}
    ...
    ITK_ARCHIVE_PATH=${ITK_ARCHIVE_PATH:-"https://github.com/fem-on-kaggle/fem-on-kaggle/releases/download/itk-20221104-105106-daccde0/itk-install.tar.gz"}
