...
if [[ ! -f $MPI4PY_INSTALLED ]]; then
    ...
    MPI4PY_ARCHIVE_PATH=${MPI4PY_ARCHIVE_PATH:-"https://github.com/fem-on-kaggle/fem-on-kaggle/releases/download/mpi4py-20231101-022331-88f5001/mpi4py-install.tar.gz"}
