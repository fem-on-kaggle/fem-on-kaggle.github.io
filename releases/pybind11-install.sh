...
if [[ ! -f $PYBIND11_INSTALLED ]]; then
    ...
    PYBIND11_ARCHIVE_PATH=${PYBIND11_ARCHIVE_PATH:-"https://github.com/fem-on-kaggle/fem-on-kaggle/releases/download/pybind11-20221105-160830-7b06de6/pybind11-install.tar.gz"}
