...
if [[ ! -f $PYBIND11_INSTALLED ]]; then
    ...
    PYBIND11_ARCHIVE_PATH=${PYBIND11_ARCHIVE_PATH:-"https://github.com/fem-on-kaggle/fem-on-kaggle/releases/download/pybind11-20231101-024521-88f5001/pybind11-install.tar.gz"}
