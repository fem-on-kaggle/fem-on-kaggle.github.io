...
if [[ ! -f $SLEPC4PY_INSTALLED ]]; then
    ...
    SLEPC4PY_ARCHIVE_PATH=${SLEPC4PY_ARCHIVE_PATH:-"https://github.com/fem-on-kaggle/fem-on-kaggle/releases/download/slepc4py-20231014-215448-594f34e-real/slepc4py-install.tar.gz"}
